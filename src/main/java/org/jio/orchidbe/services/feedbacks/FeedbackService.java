...
public class FeedbackService implements IFeedbackService{
    ...
    @Override
    public FeedbackResponse createFeedback(CreateFeedbackRequest createFeedbackRequest) throws DataNotFoundException, BadRequestException {
        ...
        if(feedbackRepository.existsByAuction_IdAndUser_Id(createFeedbackRequest.getAuctionID(),createFeedbackRequest.getUserID())){
            throw new BadRequestException("You only get 1 feedback");
        }else {
